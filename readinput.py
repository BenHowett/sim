...
def operatingprofile(design_speed, design_draught, design_cargo_capacity,
    ...
    # have been selected
    # 0 for not selected
    # 1 for selected as a draught demand
    # 2 for selected as a cargo demand
    ...
    if profile_cargo_or_draught_5 == "draught":
        ...
        # or there is an ERROR
        operating_profile_5 = 0
    
    return operating_profile_1, operating_profile_2, operating_profile_3, operating_profile_4, operating_profile_5, op_switch